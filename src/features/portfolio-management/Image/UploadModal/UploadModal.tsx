...
const UploadModal: React.FC<Props> = ({ open, onOpenChange, onUploaded }) => {
      ...
      <DialogContent className="max-w-3xl w-full max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <Upload className="w-5 h-5" /> Bulk Upload Images
          </DialogTitle>
          <DialogDescription>
            Drop multiple images or paste image URLs. All items will be uploaded
            to Cloudinary and saved to the gallery.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-5 py-2">
          ...
          {/* URL input */}
          <div className="space-y-2">
            <Label htmlFor="image-urls" className="text-sm flex items-center gap-2">
              <LinkIcon className="w-4 h-4" /> Or paste image URLs (one per line)
            </Label>
            <Textarea
              id="image-urls"
