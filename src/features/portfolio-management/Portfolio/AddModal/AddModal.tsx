                  ...
                  <div className="bg-card/50 rounded-xl p-4 md:p-6 border shadow-sm space-y-6">
                    ...
                    <div className="grid gap-6">
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-xs font-semibold uppercase text-muted-foreground tracking-wider">Title</FormLabel>
                            <FormControl>
                              <div className="relative">
                                <Type className="absolute left-3 top-2.5 h-4 w-4 text-muted-foreground" />
                                <Input {...field} placeholder="Project Title" className="pl-9 bg-background/50" />
                              </div>
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-xs font-semibold uppercase text-muted-foreground tracking-wider">Slug</FormLabel>
                            <FormControl>
                              <div className="relative">
                                <Link className="absolute left-3 top-2.5 h-4 w-4 text-muted-foreground" />
                                <Input {...field} placeholder="project-url-slug" className="pl-9 bg-background/50 font-mono text-sm" />
                              </div>
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-xs font-semibold uppercase text-muted-foreground tracking-wider">Short Description</FormLabel>
                            <FormControl>
                              <div className="relative">
                                <AlignLeft className="absolute left-3 top-2.5 h-4 w-4 text-muted-foreground" />
                                <Input {...field} placeholder="Brief summary of the project" className="pl-9 bg-background/50" />
                              </div>
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-xs font-semibold uppercase text-muted-foreground tracking-wider">Full Description</FormLabel>
                            <FormControl>
                              <Textarea
                                {...field}
                  ...
                  <div className="bg-card/50 rounded-xl p-4 md:p-6 border shadow-sm space-y-6">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <Button
                        ...
                        variant="outline"
                        size="sm"
                        onClick={() => append({ url: "", alt: "", position: fields.length })}
                        className="h-8 gap-2"
                      >
                    ...
                    <div className="space-y-4">
                      {fields.map((field, index) => (
                        <div key={field.id} className="grid grid-cols-1 md:grid-cols-[1fr,1fr,auto] gap-4 items-start p-4 rounded-lg border bg-background/30 animate-in fade-in slide-in-from-top-2">
                          <FormField
                            control={form.control}
                              ...
                              <FormItem className="space-y-1">
                                ...
                                <FormControl>
                                  <div className="relative">
                                    ...
                                    <Input {...field} placeholder="https://..." className="pl-9 h-9 text-sm" />
                                  </div>
                                </FormControl>
                                <FormMessage />
                              </FormItem>
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem className="space-y-1">
                                <FormLabel className="text-xs text-muted-foreground">Alt Text</FormLabel>
                                <FormControl>
                                  <div className="relative">
                                    <Type className="absolute left-3 top-2.5 h-3.5 w-3.5 text-muted-foreground" />
                                    <Input {...field} value={field.value || ""} placeholder="Image description" className="pl-9 h-9 text-sm" />
                                  </div>
                                </FormControl>
                                <FormMessage />
                              </FormItem>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-card/50 rounded-xl p-4 md:p-6 border shadow-sm space-y-6">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-xs font-semibold flex items-center gap-1.5"><Tags className="w-3 h-3" /> Tags</FormLabel>
                          <FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-xs font-semibold flex items-center gap-1.5"><Cpu className="w-3 h-3" /> Tech Stack</FormLabel>
                          <FormControl>
                            <SearchableMultiSelect
                              label="Techs"
                              options={
                        ...
                        <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm bg-background/50 hover:bg-accent/5 transition-colors">
                          <div className="space-y-0.5">
                            <FormLabel className="text-base font-medium flex items-center gap-2">
                              <Star className="w-4 h-4 text-amber-500" fill={field.value ? "currentColor" : "none"} />
                              Featured
                            </FormLabel>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm bg-background/50 hover:bg-accent/5 transition-colors">
                          <div className="space-y-0.5">
                            <FormLabel className="text-base font-medium flex items-center gap-2">
                              <Globe className={`w-4 h-4 ${field.value ? "text-emerald-500" : "text-muted-foreground"}`} />
                              Published
                            </FormLabel>
                            <DialogDescription className="text-xs">
